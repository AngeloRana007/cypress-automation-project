describe('Right plan page - Porting <7Mb', function () {
  before(function () {
    console.log('Load Scenario...');
    cy.loadScenarioPorting('Porting/rightplan','', 'rightplan');
    //cy.wait('@postCall');
  });
  context('When user navigates to rightplan page for a Porting scenario', function(){
