describe('Result Page - fast broadband(>7Mb)- 1 device & Browsing', function () {
  ...
  describe('Result Page - fast broadband(>7Mb)- 1 device & Streaming Music', function () {
    before(function () {
      console.log('Load Scenario...');
      cy.loadScenarioNewLine('NewLine>7Mb/result/fastbb_best','', 'rightplan');
      //cy.wait('@postCall');
  ...
  context('When user selects devices = 1 & usage=Streaming Music and then click on the check options button', function(){
    it('should navigate to result page', function(){
      cy.get(`.rprcRadioButtonContainer.rprc_users rprc-radio-button:nth-child(1)`)
      .click();
...
describe('Result Page - fast broadband(>7Mb)- 1 device & Video Calls', function () {
  before(function () {
    console.log('Load Scenario...');
    cy.loadScenarioNewLine('NewLine>7Mb/result/fastbb_best','', 'rightplan');
    //cy.wait('@postCall');
  ...
  context('When user selects devices = 1 & usage=Video Calls and then click on the check options button', function(){
    it('should navigate to result page', function(){
      cy.get(`.rprcRadioButtonContainer.rprc_users rprc-radio-button:nth-child(1)`)
      .click();
      cy.get(`.rprcRadioButtonContainer.rprc_activities rprc-radio-button:nth-child(3)`)
      .click();
      cy.get('#confirmOrderButton-id').should('have','Get plan options')
      .click();
      cy.url().should('contain', 'result')
...
describe('Result Page - fast broadband(>7Mb)- 1 device & Streaming Video', function () {
  before(function () {
    console.log('Load Scenario...');
    cy.loadScenarioNewLine('NewLine>7Mb/result/fastbb_best','', 'rightplan');
    //cy.wait('@postCall');
...
describe('Result Page - fast broadband(>7Mb)- 1 device & Online Gaming', function () {
  before(function () {
    console.log('Load Scenario...');
    cy.loadScenarioNewLine('NewLine>7Mb/result/fastbb_best','', 'rightplan');
    //cy.wait('@postCall');
