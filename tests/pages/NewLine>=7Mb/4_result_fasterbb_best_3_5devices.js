describe('Result Page - faster broadband(<7Mb)- 3-5 devices & Streaming Music', function () {
  before(function () {
    console.log('Load Scenario...');
    cy.loadScenarioNewLine('NewLine>7Mb/result/faster_best','', 'rightplan');
    //cy.wait('@postCall');
  });
/*  context('When user selects devices = 3-5  & usage=Streaming Music and then click on the check options button', function(){
    ...
    it('should get `Faster Broadband` as pre-selected result', function(){
      cy.get('.rprcSelectBroadbandContainer rprc-select-broadband:nth-child(2) section')
...
describe('Result Page - faster broadband(>7Mb)- 3-5 devices & Streaming Video', function () {
  before(function () {
    console.log('Load Scenario...');
    cy.loadScenarioNewLine('NewLine>7Mb/result/faster_best','', 'rightplan');
    //cy.wait('@postCall');
  ...
  context('When user selects devices = 3-5  & usage=Streaming Video and then click on the check options button', function(){
    it('should navigate to result page', function(){
      cy.get(`.rprcRadioButtonContainer.rprc_users rprc-radio-button:nth-child(2)`)
      .click();
      cy.get(`.rprcRadioButtonContainer.rprc_activities rprc-radio-button:nth-child(4)`)
      .click();
...
describe('Result Page - faster broadband(>7Mb)- 3-5 devices & Online Gaming', function () {
  before(function () {
    console.log('Load Scenario...');
    cy.loadScenarioNewLine('NewLine>7Mb/result/faster_best','', 'rightplan');
    //cy.wait('@postCall');
  ...
  context('When user selects devices = 3-5  & usage=Online Gaming and then click on the check options button', function(){
    it('should navigate to result page', function(){
      cy.get(`.rprcRadioButtonContainer.rprc_users rprc-radio-button:nth-child(2)`)
      .click();
      cy.get(`.rprcRadioButtonContainer.rprc_activities rprc-radio-button:nth-child(5)`)
      .click();
      cy.get('#confirmOrderButton-id').should('have','Get plan options')
      .click();
      cy.url().should('contain', 'result')
...
describe('Result Page - faster broadband(>7Mb)- 3-5 devices & Downloading/uploading video', function () {
  before(function () {
    console.log('Load Scenario...');
    cy.loadScenarioNewLine('NewLine>7Mb/result/faster_best','', 'rightplan');
    //cy.wait('@postCall');
  ...
  context('When user selects devices = 3-5  & usage=Downloading/uploading video and then click on the check options button', function(){
    it('should navigate to result page', function(){
      cy.get(`.rprcRadioButtonContainer.rprc_users rprc-radio-button:nth-child(2)`)
      .click();
      cy.get(`.rprcRadioButtonContainer.rprc_activities rprc-radio-button:nth-child(6)`)
      .click();
      cy.get('#confirmOrderButton-id').should('have','Get plan options')
      .click();
      cy.url().should('contain', 'result')
...
describe('Result Page - faster broadband(>7Mb)- 3-5 devices & all 6 activies selected', function () {
  before(function () {
    console.log('Load Scenario...');
    cy.loadScenarioNewLine('NewLine>7Mb/result/faster_best','', 'rightplan');
    //cy.wait('@postCall');
