...
describe('Result Page - faster broadband(<7Mb strongly recommended)- 1 device & Video Calls', function () {
  before(function () {
    console.log('Load Scenario...');
    cy.loadScenarioNewLine('NewLine/result/faster_strongRec_best','', 'rightplan');
    //cy.wait('@postCall');
...
describe('Result Page - faster broadband(<7Mb strongly recommended)- 1 device & Streaming Video', function () {
  before(function () {
    console.log('Load Scenario...');
    cy.loadScenarioNewLine('NewLine/result/faster_strongRec_best','', 'rightplan');
    //cy.wait('@postCall');
...
describe('Result Page - faster broadband(<7Mb strongly recommended)- 1 device & Online Gaming', function () {
  before(function () {
    console.log('Load Scenario...');
    cy.loadScenarioNewLine('NewLine/result/faster_strongRec_best','', 'rightplan');
    //cy.wait('@postCall');
...
describe('Result Page - faster broadband(<7Mb strongly recommended)- 1 device & Downloading/uploading video', function () {
  before(function () {
    console.log('Load Scenario...');
    cy.loadScenarioNewLine('NewLine/result/faster_strongRec_best','', 'rightplan');
    //cy.wait('@postCall');
...
describe('Result Page - faster broadband(<7Mb strongly recommended)- 1 device & all 6 activies selected', function () {
  before(function () {
    console.log('Load Scenario...');
    cy.loadScenarioNewLine('NewLine/result/faster_strongRec_best','', 'rightplan');
    //cy.wait('@postCall');
