Cypress.Commands.add("loadScenarioPorting",(scenario, variant, pageUrl) => {
  return cy.server().then(() => {
    ...
    //const salesApi = 'https://kil-sales-bau.infosys-20.nec.talkdev.co.uk/sales-api/';
    //https://kil-sales-bau.infosys-20.nec.talkdev.co.uk/sales-api/
    ...
    var endPoint20= `${salesApi}/availability-check/get-address`;
    var endPoint20_1= `${salesApi}/availability-check/set-address`;
    //https://yor-sales-promotion.infosys-18.nec.talkdev.co.uk/sales-api/availability-check/get-address
    ...
    cy.route('POST', endPoint20, `fixture:${scenario}/get-address.json`).as('getAddress');
    cy.route('POST', endPoint20_1, `fixture:${scenario}/set-address.json`).as('setAddress');
    ...
    cy.route('GET', `${baseUrl}/stubs/scenarios.json`, `fixture:${scenario}/scenarios.json`);
    ...
    //cy.route('GET',`${contentful}/0zd818fqktdq/entries?include=0&content_type=page&fields.path=home/v`, {id: "xhr629"});
    //  https://cdn.contentful.com/spaces/0zd818fqktdq/entries?include=0&content_type=page&fields.path=home/v
